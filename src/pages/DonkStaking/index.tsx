...
export default function Stake() {
  ...
  return (
    <div className=" pt-5 pb-14 min-h-[80vh]">
      <section className="max-w-6xl w-[90%] mx-auto">
        <header className="flex items-center justify-between mb-5 gap-1">
          <div>
            <h2 className="font-semibold sm:text-4xl text-3xl mb-1 dark:text-white">Stake</h2>
            <p className="text-sm font-medium text-pink900 dark:text-dark900">Stake your DONK tokens and earn more.</p>
          </div>
