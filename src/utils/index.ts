...
import { abi as IUniswapV2Router02ABI } from '@donkswap/periphery/build/IUniswapV2Router02.json'
import {
  ChainId,
  JSBI,
  Percent,
...
export function getEtherscanLink(
  ...
  prefix = [ChainId.SEPOLIA, ChainId.ARBITRUM, ChainId.POLYGON, ChainId.BINANCE].includes(chainId)
    ? prefix
    : `${prefix}etherscan.io`
